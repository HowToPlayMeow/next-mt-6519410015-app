...
export default function Projects()
{
  return (
    <div className="flex flex-col justify-center h-full w-full">
      ...
      <h1 className="text-4xl text-white font-bold mb-6">Featured <span className="text-[#FF8A00]">Projects</span></h1>

      <div className="mb-6">

        <h4 className="text-white font-bold text-base mb-2">Manage Task App - fullstack web development</h4>
