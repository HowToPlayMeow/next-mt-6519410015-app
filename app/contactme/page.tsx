      ...
      <form className="flex flex-col gap-6 max-w-2xl w-full">
        ...
        <div className="grid grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            ...
            <input type="email" className="bg-transparent border-b border-gray-600 text-white focus:outline-none focus:border-[#FF8A00] pb-2 transition-colors" />
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-[#FF8A00] text-xs font-medium">Phone</label>
            <input type="tel" className="bg-transparent border-b border-gray-600 text-white focus:outline-none focus:border-[#FF8A00] pb-2 transition-colors" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-10">
          <div className="flex flex-col gap-2">
            ...
            <input type="text" className="bg-transparent border-b border-gray-600 text-white focus:outline-none focus:border-[#FF8A00] pb-2 transition-colors" />
          </div>
          <div className="flex flex-col gap-2">
